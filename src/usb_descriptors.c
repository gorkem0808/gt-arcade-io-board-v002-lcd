...
// Absolute mouse report + keyboard report in one HID interface.
uint8_t const desc_hid_report[] = {
    // Report ID 1: absolute mouse, 5 bytes: buttons, x16, y16
...
tusb_desc_device_t const desc_device = {
    ...
    .idVendor = 0xCafe,
    .idProduct = (PLAYER_ID == 1) ? 0x4011 : 0x4012,
    .bcdDevice = 0x0200,
    .iManufacturer = 0x01,
    .iProduct = 0x02,
    .iSerialNumber = 0x03,
